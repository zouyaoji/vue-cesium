...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/en-US/controls/vc-navigation.md?vue&type=template&id=0d39fc59

const vc_navigationvue_type_template_id_0d39fc59_hoisted_1 = {
  class: "content element-doc"
};

const vc_navigationvue_type_template_id_0d39fc59_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<h2 id=\"vcnavigation\"><a class=\"header-anchor\" href=\"#vcnavigation\">¶</a> VcNavigation</h2><p>Navigation components, including compass, zoom, other floating buttons, position and distance scale toolbar controls. It is composed of <code>vc-compass</code>, <code>vc-zoom-control</code>, <code>vc-print</code>, <code>vc-mylocation</code>, <code>vc-status-bar</code>, and <code>vc-distance-legend</code>.</p><p><strong>Note:</strong> Style files need to be imported: <code>import &#39;vue-cesium/dist/index.css&#39;;</code></p><div class=\"tip\"><p>Tip: The navigation component has been refactored in version 3.0. It is now a collection component and now supports custom styles, including icons, sizes, color positions, etc. The icon currently uses Unicode and does not support multi-color. If you need to support multi-color, please refer to the method of using Symbol introduced by Alibaba Cloud iconfont: <a href=\"https://www.iconfont.cn/help/detail?spm=a313x.7781069.1998910419.d8cf4382a&amp;helptype=code\">Portal</a></p></div><h3 id=\"basic-usage\"><a class=\"header-anchor\" href=\"#basic-usage\">¶</a> Basic usage</h3><p>Basic usage of VcNavigation component.</p>", 6);
...
const _hoisted_10 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<h3 id=\"extended-usage\"><a class=\"header-anchor\" href=\"#extended-usage\">¶</a> Extended usage</h3><p>Customize navigation components as needed. The available components are: <code>vc-compass</code>, <code>vc-zoom-control</code>, <code>vc-print</code>, <code>vc-mylocation</code>, <code>vc-status-bar</code>, <code>vc-distance-legend</code>.</p>", 2);

const _hoisted_12 = /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("div", null, [/*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("p", null, "Customize each navigation component as needed")], -1);
...
function vc_navigationvue_type_template_id_0d39fc59_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", vc_navigationvue_type_template_id_0d39fc59_hoisted_1, [vc_navigationvue_type_template_id_0d39fc59_hoisted_2, Object(vue_esm_browser["createVNode"])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/en-US/controls/vc-navigation.md?vue&type=template&id=0d39fc59
...
vc_navigationvue_type_script_lang_ts.render = vc_navigationvue_type_template_id_0d39fc59_render
