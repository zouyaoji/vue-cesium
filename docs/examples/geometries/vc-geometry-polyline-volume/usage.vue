...
import type { VcGeometryInstanceProps, VcGeometryPolylineVolumeOutlineRef, VcGeometryPolylineVolumeRef } from 'vue-cesium'
import type { VcAppearance, VcPickEvent, VcReadyObject } from 'vue-cesium/es/utils/types'
import { onMounted, ref, shallowRef } from 'vue'

const geometryRef = shallowRef<VcGeometryPolylineVolumeRef>()
const geometryOutlineRef = shallowRef<VcGeometryPolylineVolumeOutlineRef>()
...
function onViewerReady({ Cesium, viewer }: VcReadyObject) {
  const { ColorGeometryInstanceAttribute, PerInstanceColorAppearance, VertexFormat } = Cesium
  attributes.value = {
  ...
  vertexFormat.value = VertexFormat.POSITION_AND_NORMAL
}
...
<template>
  <el-row class="demo-viewer demo-vc-geometry-polyline-volume">
