 ...
 * @LastEditTime: 2026-02-03 13:40:30
 * @FilePath: \vue-cesium\docs\examples\providers\vc-imagery-provider-wms\usage.vue
-->
<script setup>
import { ref } from 'vue'
...
<template>
  <div class="demo-viewer demo-vc-imagery-provider-wms">
