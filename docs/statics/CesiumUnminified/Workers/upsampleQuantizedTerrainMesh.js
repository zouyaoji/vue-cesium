...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-d4357f39', './Cartesian2-d70cd429', './Transforms-6f36fec5', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './AttributeCompression-9b51d360', './IndexDatatype-573b6d9d', './IntersectionTests-5747420e', './Plane-e219c346', './createTaskProcessorWorker', './EllipsoidTangentPlane-4d6d2abe', './OrientedBoundingBox-0ed4010d', './TerrainEncoding-30cf3788'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
