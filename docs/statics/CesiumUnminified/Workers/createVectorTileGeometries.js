...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-d4357f39', './Cartesian2-d70cd429', './Transforms-6f36fec5', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './GeometryAttribute-57b7635e', './GeometryAttributes-90846c5f', './IndexDatatype-573b6d9d', './createTaskProcessorWorker', './GeometryOffsetAttribute-9c676324', './VertexFormat-fe64931e', './BoxGeometry-0ce3ad7a', './CylinderGeometryLibrary-88e64f9c', './CylinderGeometry-bfb492c9', './EllipsoidGeometry-4c96e99b', './Color-0105ef26'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, createTaskProcessorWorker, GeometryOffsetAttribute, VertexFormat, BoxGeometry, CylinderGeometryLibrary, CylinderGeometry, EllipsoidGeometry, Color) { 'use strict';
