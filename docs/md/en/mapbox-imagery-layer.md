...
`mapbox-imagery-layer`Provides tiled imagery hosted by Mapbox.
...
|------|----|----|
|ready|{Cesium, viewer}|Triggers when MapboxImageryLayer is ready. It returns a core class of Cesium, a viewer instance.|
