...
`model-primitive` Used to add the gltf model.

## Example

### add a gltf model to viewer by ModelPrimitive
  ...
  <template>
    <div class="viewer">
      <cesium-viewer @ready="ready">
        <model-primitive :url="url" :modelMatrix="modelMatrix" :scale="10000" :minimumPixelSize="128" :maximumScale="200000"> </model-primitive>
      </cesium-viewer>
    </div>
  </template>
...
- Reference official document [Model](https://cesium.com/docs/cesiumjs-ref-doc/Model.html).
