  ...
  <div ref="target" class="home-page">
    <div class="banner" text="center">
      <div class="banner-desc">
        ...
        <p>
          <strong>
            <VPLink class="is-menu-link" href="https://cesium.com/learn/certified-developer-directory" :no-icon="true">
              {{ homeLang.certified_developer }}
            </VPLink>
          </strong>
        </p>
      </div>
    ...
    <img :src="withBase(`/images/theme-index-blue${isDark ? '-dark' : ''}.png`)" alt="banner" class="mobile-banner">
    <HomeSponsors />
    <HomeCards />
  </div>
