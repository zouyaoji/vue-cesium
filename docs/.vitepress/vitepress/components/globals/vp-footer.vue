...
<template>
  <footer class="footer" :class="{ 'is-home': isHome }">
    <div class="footer-main">
      ...
      <a
        href="http://github.com/zouyaoji/vue-cesium/releases"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['12'] }}
    ...
    <div class="footer-main">
      <h4>{{ homeLang['19'] }}</h4>
      <a
        href="https://github.com/zouyaoji/vue-cesium"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['11'] }}
      ...
      <a
        href="http://github.com/zouyaoji/vue-cesium/issues"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['16'] }}
      ...
      <a
        href="http://github.com/zouyaoji/vue-cesium/blob/dev/.github/CONTRIBUTING.en-US.md"
        class="footer-main-link"
        target="_blank"
      >
        {{ homeLang['17'] }}
