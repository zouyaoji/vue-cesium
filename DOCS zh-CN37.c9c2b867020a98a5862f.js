...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/vc-entity.md?vue&type=template&id=54ba6ae2

var vc_entityvue_type_template_id_54ba6ae2_hoisted_1 = {
  class: "content element-doc"
};

var vc_entityvue_type_template_id_54ba6ae2_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["l" /* createStaticVNode */])("<h2 id=\"shi-ti\"><a class=\"header-anchor\" href=\"#shi-ti\">¶</a> 实体</h2><p><code>vc-entity</code> 组件用于加载实体对象，相当于初始化一个 <code>Cesium.Entity</code> 实例。需要作为 <code>vc-viewer</code>, <code>vc-datasource-custom</code>, <code>vc-datasource-geojson</code>, <code>vc-datasource-kml</code>, <code>vc-datasource-czml</code> 的子组件才能正常加载。使用时可以直接指定 <code>vc-entity</code> 的各个 <code>graphic</code> 属性，也用 VueCesium 提供的 <code>vc-graphics-xxx</code> 系列组件作为 <code>vc-entity</code> 子组件挂载各个 <code>graphic</code>，但一个实体下同类型 <code>grahpic</code> 只能挂载一个。如果需要加载大量实体实例集合，建议添加到数据源组件下。</p><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>实体实例组件的基础用法。</p>", 4);
...
function vc_entityvue_type_template_id_54ba6ae2_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["i" /* createBlock */])("section", vc_entityvue_type_template_id_54ba6ae2_hoisted_1, [vc_entityvue_type_template_id_54ba6ae2_hoisted_2, Object(vue_esm_browser["n" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/vc-entity.md?vue&type=template&id=54ba6ae2
...
vc_entityvue_type_script_lang_ts.render = vc_entityvue_type_template_id_54ba6ae2_render
