...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/en-US/vc-viewer.md?vue&type=template&id=6d84f078

const vc_viewervue_type_template_id_6d84f078_hoisted_1 = {
  class: "content element-doc"
};

const vc_viewervue_type_template_id_6d84f078_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<h2 id=\"vcviewer\"><a class=\"header-anchor\" href=\"#vcviewer\">¶</a> VcViewer</h2><p>The basic component used to build the <code>Cesium</code> application is essentially a DOM node initialized by <code>Cesium.Viewer</code>, which is used to mount other DOM nodes or components.</p><p><strong>Note:</strong> Other components of <code>vue-cesium</code> or custom components composed of them need to be placed under this component to load normally. After the initialization is complete, you can obtain the returned <code>Cesium</code> and <code>Viewer</code> instances in the <code>ready</code> event for Cesium API development, or use <code>ref</code> to obtain the component&#39;s <code>createPromise</code> object to get the Viewer instance.</p><h3 id=\"basic-usage\"><a class=\"header-anchor\" href=\"#basic-usage\">¶</a> Basic usage</h3><p>Basic usage of <code>vc-viewer</code>.</p>", 5);
...
function vc_viewervue_type_template_id_6d84f078_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", vc_viewervue_type_template_id_6d84f078_hoisted_1, [vc_viewervue_type_template_id_6d84f078_hoisted_2, Object(vue_esm_browser["createVNode"])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/en-US/vc-viewer.md?vue&type=template&id=6d84f078
...
vc_viewervue_type_script_lang_ts.render = vc_viewervue_type_template_id_6d84f078_render
