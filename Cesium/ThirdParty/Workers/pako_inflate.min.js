  ...
  })(
    {
      ...
      2: [
        function (e, t, i) {
          ...
          function f(e, t) {
            if (t < 65534 && ((e.subarray && r) || (!e.subarray && a))) return String.fromCharCode.apply(null, n.shrinkBuf(e, t))
          ...
          ;(o[254] = o[254] = 1),
              ...
              for (t = new n.Buf8(f), r = o = 0; o < f; r++)
                55296 == (64512 & (i = e.charCodeAt(r))) &&
                  ...
                  i < 128
                    ...
                    : (i < 2048
                        ? (t[o++] = 192 | (i >>> 6))
                        : (i < 65536 ? (t[o++] = 224 | (i >>> 12)) : ((t[o++] = 240 | (i >>> 18)), (t[o++] = 128 | ((i >>> 12) & 63))),
                          (t[o++] = 128 | ((i >>> 6) & 63))),
                      (t[o++] = 128 | (63 & i)))
              return t
            }),
            ...
            (i.binstring2buf = function (e) {
              for (var t = new n.Buf8(e.length), i = 0, a = t.length; i < a; i++) t[i] = e.charCodeAt(i)
              return t
            }),
            (i.buf2string = function (e, t) {
              ...
              for (i = n = 0; i < s; )
                if ((a = e[i++]) < 128) l[n++] = a
                  ...
                  for (a &= 2 === r ? 31 : 3 === r ? 15 : 7; 1 < r && i < s; ) (a = (a << 6) | (63 & e[i++])), r--
                  1 < r
                    ? (l[n++] = 65533)
                    : a < 65536
                    ? (l[n++] = a)
                    : ((a -= 65536), (l[n++] = 55296 | ((a >> 10) & 1023)), (l[n++] = 56320 | (1023 & a)))
                }
              return f(l, n)
            }),
              ...
              t: for (;;) {
                if (((h >>>= v = g >>> 24), (b -= v), 0 == (v = (g >>> 16) & 255))) Z[r++] = 65535 & g
                  ...
                  i: for (;;) {
                    ...
                    if (
                      ((x = 65535 & g),
                      b < (v &= 15) && ((h += E[n++] << b), (b += 8) < v && ((h += E[n++] << b), (b += 8))),
                      f < (x += h & ((1 << v) - 1)))
                    ) {
      ...
      8: [
        function (e, t, i) {
          ...
          function u(e) {
            var t
            return e && e.state ? (((t = e.state).wsize = 0), (t.whave = 0), (t.wnext = 0), c(e)) : f
          }
          function h(e, t) {
            var i, n
            return e && e.state
              ? ((n = e.state),
                ...
                t && (t < 8 || 15 < t) ? f : (null !== n.window && n.wbits !== t && (n.window = null), (n.wrap = i), (n.wbits = t), u(e)))
              : f
          }
          function b(e, t) {
            var i, n
            return e ? ((n = new d()), ((e.state = n).window = null), 0 !== (i = h(e, t)) && (e.state = null), i) : f
          }
          var m,
            w,
            k = !0
          function _(e) {
            if (k) {
              ...
              for (s(1, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0; t < 32; ) e.lens[t++] = 5
          ...
          function g(e, t, i, a) {
            ...
            return (
              ...
              a >= o.wsize
                ? (n.arraySet(o.window, t, i - o.wsize, o.wsize, 0), (o.wnext = 0), (o.whave = o.wsize))
          ...
          ;(i.inflateReset = u),
            ...
            (i.inflate = function (e, t) {
              ...
              e: for (;;)
                switch (i.mode) {
                  case 1:
                    ...
                    if (2 & i.wrap && 35615 === w) {
                      ;(T[(i.check = 0)] = 255 & w), (T[1] = (w >>> 8) & 255), (i.check = r(i.check, T, 2, 0)), (k = w = 0), (i.mode = 2)
                      break
                    }
                    ...
                    ;(i.dmax = 1 << N), (e.adler = i.check = 1), (i.mode = 512 & w ? 10 : 12), (k = w = 0)
                    break
                  case 2:
                    for (; k < 16; ) {
                      if (0 === b) break e
                    ...
                    i.head && (i.head.text = (w >> 8) & 1),
                      512 & i.flags && ((T[0] = 255 & w), (T[1] = (w >>> 8) & 255), (i.check = r(i.check, T, 2, 0))),
                      (k = w = 0),
                      (i.mode = 3)
                  case 3:
                    for (; k < 32; ) {
                  ...
                  case 7:
                    if (2048 & i.flags) {
                      if (0 === b) break e
                      for (x = 0; (N = d[u + x++]), i.head && N && i.length < 65536 && (i.head.name += String.fromCharCode(N)), N && x < b; );
                      if ((512 & i.flags && (i.check = r(i.check, d, x, u)), (b -= x), (u += x), N)) break e
                    } else i.head && (i.head.name = null)
                    ;(i.length = 0), (i.mode = 8)
                  case 8:
                    if (4096 & i.flags) {
                      if (0 === b) break e
                      for (x = 0; (N = d[u + x++]), i.head && N && i.length < 65536 && (i.head.comment += String.fromCharCode(N)), N && x < b; );
                      if ((512 & i.flags && (i.check = r(i.check, d, x, u)), (b -= x), (u += x), N)) break e
                  ...
                  case 11:
                    if (0 === i.havedict) return (e.next_out = h), (e.avail_out = m), (e.next_in = u), (e.avail_in = b), (i.hold = w), (i.bits = k), 2
                  ...
                  case 16:
                    if ((x = i.length)) {
                      ...
                      n.arraySet(c, d, u, x, h), (b -= x), (u += x), (m -= x), (h += x), (i.length -= x)
                      break
                    }
                    i.mode = 12
                    break
                  ...
                  case 19:
                    for (; i.have < i.nlen + i.ndist; ) {
                      for (; (Z = ((D = i.lencode[w & ((1 << i.lenbits) - 1)]) >>> 16) & 255), (B = 65535 & D), !((E = D >>> 24) <= k); ) {
                        if (0 === b) break e
                        b--, (w += d[u++] << k), (k += 8)
                      }
                    ...
                    if (
                      ((i.lenbits = 9), (C = { bits: i.lenbits }), (O = s(1, i.lens, 0, i.nlen, i.lencode, 0, i.work, C)), (i.lenbits = C.bits), O)
                    ) {
                  ...
                  case 21:
                    ...
                    for (i.back = 0; (Z = ((D = i.lencode[w & ((1 << i.lenbits) - 1)]) >>> 16) & 255), (B = 65535 & D), !((E = D >>> 24) <= k); ) {
                      if (0 === b) break e
                      b--, (w += d[u++] << k), (k += 8)
                    }
                    if (Z && 0 == (240 & Z)) {
                      for (
                        A = E, z = Z, R = B;
                        (Z = ((D = i.lencode[R + ((w & ((1 << (A + z)) - 1)) >> A)]) >>> 16) & 255), (B = 65535 & D), !(A + (E = D >>> 24) <= k);
                  ...
                  case 22:
                    if (i.extra) {
                      ...
                      ;(i.length += w & ((1 << i.extra) - 1)), (w >>>= i.extra), (k -= i.extra), (i.back += i.extra)
                    }
                    ;(i.was = i.length), (i.mode = 23)
                  case 23:
                    for (; (Z = ((D = i.distcode[w & ((1 << i.distbits) - 1)]) >>> 16) & 255), (B = 65535 & D), !((E = D >>> 24) <= k); ) {
                      if (0 === b) break e
                      b--, (w += d[u++] << k), (k += 8)
                    }
                    if (0 == (240 & Z)) {
                      for (
                        A = E, z = Z, R = B;
                        (Z = ((D = i.distcode[R + ((w & ((1 << (A + z)) - 1)) >> A)]) >>> 16) & 255), (B = 65535 & D), !(A + (E = D >>> 24) <= k);
                  ...
                  case 24:
                    if (i.extra) {
                      ...
                      ;(i.offset += w & ((1 << i.extra) - 1)), (w >>>= i.extra), (k -= i.extra), (i.back += i.extra)
                    }
                    if (i.offset > i.dmax) {
                      ;(e.msg = 'invalid distance too far back'), (i.mode = 30)
                      break
                  ...
                  case 25:
                    ...
                    if (((x = p - m), i.offset > x)) {
                      ...
                      x > i.wnext ? ((x -= i.wnext), (y = i.wsize - x)) : (y = i.wnext - x), x > i.length && (x = i.length), (S = i.window)
                  ...
                  case 27:
                    if (i.wrap) {
                      ...
                      if (
                        ...
                        (e.total_out += p),
                        (i.total += p),
                        p && (e.adler = i.check = i.flags ? r(i.check, c, p, h - p) : a(i.check, c, p, h - p)),
                        (p = m),
              ...
              return (
                ...
                (i.hold = w),
                (i.bits = k),
                (i.wsize || (p !== e.avail_out && i.mode < 30 && (i.mode < 27 || 4 !== t))) && g(e, e.output, e.next_out, p - e.avail_out)
                  ? ((i.mode = 31), -4)
                  : ((v -= e.avail_in),
                    (p -= e.avail_out),
                    (e.total_in += v),
                    (e.total_out += p),
                    (i.total += p),
                    i.wrap && p && (e.adler = i.check = i.flags ? r(i.check, c, p, e.next_out - p) : a(i.check, c, p, e.next_out - p)),
            ...
            (i.inflateGetHeader = function (e, t) {
              var i
              return e && e.state ? (0 == (2 & (i = e.state).wrap) ? f : (((i.head = t).done = !1), 0)) : f
            }),
      ...
      9: [
        function (e, t, i) {
          ...
          t.exports = function (e, t, i, f, l, d, c, u) {
            ...
            if ((Z < B && (B = Z), 0 === Z)) return (l[d++] = 20971520), (l[d++] = 20971520), (u.bits = 1), 0
            for (E = 1; E < Z && 0 === D[E]; E++);
            for (B < E && (B = E), y = R = 1; y <= 15; y++) if (((R <<= 1), (R -= D[y]) < 0)) return -1
            if (0 < R && (0 === e || 1 !== Z)) return -1
            for (T[1] = 0, y = 1; y < 15; y++) T[y + 1] = T[y] + D[y]
            for (S = 0; S < f; S++) 0 !== t[i + S] && (c[T[t[i + S]]++] = S)
            if (
              (0 === e ? ((C = U = c), (_ = 19)) : 1 === e ? ((C = a), (I -= 257), (U = r), (F -= 257), (_ = 256)) : ((C = o), (U = s), (_ = -1)),
              (y = E),
              (k = d),
              (z = S = O = 0),
              (m = -1),
            ...
            for (;;) {
              for (
                g = y - z,
                  c[S] < _ ? ((v = 0), (p = c[S])) : c[S] > _ ? ((v = U[F + c[S]]), (p = C[I + c[S]])) : ((v = 96), (p = 0)),
                  h = 1 << (y - z),
                  E = b = 1 << A;
              ...
              if (B < y && (O & w) !== m) {
                for (0 === z && (z = B), k += E, R = 1 << (A = y - z); A + z < Z && !((R -= D[A + z]) <= 0); ) A++, (R <<= 1)
      ...
      '/lib/inflate.js': [
        function (e, t, i) {
          ...
          ;(c.prototype.push = function (e, t) {
            ...
            do {
              if (
                (0 === u.avail_out && ((u.output = new a.Buf8(h)), (u.next_out = 0), (u.avail_out = h)),
                (i = n.inflate(u, o.Z_NO_FLUSH)) === o.Z_NEED_DICT && b && (i = n.inflateSetDictionary(this.strm, b)),
                i === o.Z_BUF_ERROR && !0 === m && ((i = o.Z_OK), (m = !1)),
                i !== o.Z_STREAM_END && i !== o.Z_OK)
              )
                return this.onEnd(i), !(this.ended = !0)
              u.next_out &&
                ((0 !== u.avail_out && i !== o.Z_STREAM_END && (0 !== u.avail_in || (s !== o.Z_FINISH && s !== o.Z_SYNC_FLUSH))) ||
