define([
    ...
    for (let e = 0; e < u; e++)
      for (let e = 0; e < i.length; e += 3)
        (g = t.Cartesian3.fromArray(i, e, g)),
          (g = t.Matrix3.multiplyByVector(f, g, g)),
  ...
  function F(e, a, n, i, o, c, C, u, d, g) {
    const y = t.Cartesian3.angleBetween(t.Cartesian3.subtract(a, e, E), t.Cartesian3.subtract(n, e, P)),
      f = i === l.BEVELED ? 0 : Math.ceil(y / r.CesiumMath.toRadians(5))
    let h, m, p
    if (
      ((h = o
        ? t.Matrix3.fromQuaternion(s.Quaternion.fromAxisAngle(t.Cartesian3.negate(e, E), y / (f + 1), j), q)
        : t.Matrix3.fromQuaternion(s.Quaternion.fromAxisAngle(e, y / (f + 1), j), q)),
      (a = t.Cartesian3.clone(a, Q)),
      f > 0)
    ) {
      const n = g ? 2 : 1
      for (let r = 0; r < f; r++)
        (a = t.Matrix3.multiplyByVector(h, a, a)),
          (m = t.Cartesian3.subtract(a, e, E)),
          (m = t.Cartesian3.normalize(m, m)),
          o || (m = t.Cartesian3.negate(m, m)),
    ...
    const c = s._ellipsoid,
      P = (function (e, a) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n]
          ;(b = a.cartesianToCartographic(r, b)), (t[n] = b.height), (e[n] = a.scaleToGeodeticSurface(r, r))
        }
        return t
      })(e, c),
      B = s._granularity,
