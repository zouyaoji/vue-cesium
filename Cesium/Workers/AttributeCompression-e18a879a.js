define([
  ...
  const d = new e.Cartesian2()
  function m(t) {
    return (t >> 1) ^ -(1 & t)
  }
  ;(i.octEncodeFloat = function (t) {
    return i.octEncode(t, d), i.octPackFloat(d)
  }),
    ...
    (i.zigZagDeltaDecode = function (t, e, n) {
      ...
      let r = 0,
        c = 0,
        s = 0
      for (let u = 0; u < o; ++u) (r += m(t[u])), (c += m(e[u])), (t[u] = r), (e[u] = c), a.defined(n) && ((s += m(n[u])), (n[u] = s))
    }),
