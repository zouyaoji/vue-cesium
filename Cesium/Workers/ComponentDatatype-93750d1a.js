define(['exports', './RuntimeError-346a3079', './when-4bbc8319', './WebGLConstants-1c8239cc'], function (t, n, r, e) {
  'use strict'
  var a = function (t) {
  ...
  ;(a.prototype.init_seed = function (t) {
    ...
    (a.prototype.init_by_array = function (t, n) {
      ...
      for (this.init_seed(19650218), r = 1, e = 0, a = this.N > n ? this.N : n; a; a--) {
        ...
        ;(this.mt[r] = (this.mt[r] ^ (((1664525 * ((4294901760 & i) >>> 16)) << 16) + 1664525 * (65535 & i))) + t[e] + e),
          (this.mt[r] >>>= 0),
          e++,
    ...
    (a.prototype.random_int = function () {
      ...
      if (this.mti >= this.N) {
        ...
        for (this.mti == this.N + 1 && this.init_seed(5489), r = 0; r < this.N - this.M; r++)
          (t = (this.mt[r] & this.UPPER_MASK) | (this.mt[r + 1] & this.LOWER_MASK)), (this.mt[r] = this.mt[r + this.M] ^ (t >>> 1) ^ n[1 & t])
        for (; r < this.N - 1; r++)
  ...
  ;(s.setRandomNumberSeed = function (t) {
    ...
    (s.fastApproximateAtan2 = function (t, n) {
      ...
      return (a = s.fastApproximateAtan(i)), (a = Math.abs(n) > Math.abs(t) ? s.PI_OVER_TWO - a : a), (a = t < 0 ? s.PI - a : a), (a = n < 0 ? -a : a)
    })
  var E = {
      ...
      createArrayBufferView: function (t, n, e, a) {
        switch (((e = r.defaultValue(e, 0)), (a = r.defaultValue(a, (n.byteLength - e) / E.getSizeInBytes(t))), t)) {
          case E.BYTE:
