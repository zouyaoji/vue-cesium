...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/vc-viewer.md?vue&type=template&id=c1e9e30e

var vc_viewervue_type_template_id_c1e9e30e_hoisted_1 = {
  class: "content element-doc"
};

var vc_viewervue_type_template_id_c1e9e30e_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["l" /* createStaticVNode */])("<h2 id=\"vcviewer\"><a class=\"header-anchor\" href=\"#vcviewer\">¶</a> VcViewer</h2><p>构建 <code>Cesium</code> 应用程序的基础组件，其实质是通过 <code>Cesium.Viewer</code> 初始化的一个 DOM 节点，用于挂载其他 DOM 节点或者子组件。</p><p><strong>注意:</strong> <code>vue-cesium</code> 的其他组件或由它们构成的自定义组件都需要放在该组件下面才能正常加载。初始化完成后，可以在 <code>ready</code> 事件中获取返回的 <code>Cesium</code> 和 <code>Viewer</code> 实例用于 Cesium API 开发，也可以通过 <code>ref</code> 来获取组件的 <code>createPromise</code> 对象来得到 Viewer 实例。</p><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>三维场景容器组件的基础用法。</p>", 5);
...
function vc_viewervue_type_template_id_c1e9e30e_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["i" /* createBlock */])("section", vc_viewervue_type_template_id_c1e9e30e_hoisted_1, [vc_viewervue_type_template_id_c1e9e30e_hoisted_2, Object(vue_esm_browser["n" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/vc-viewer.md?vue&type=template&id=c1e9e30e
...
vc_viewervue_type_script_lang_ts.render = vc_viewervue_type_template_id_c1e9e30e_render
