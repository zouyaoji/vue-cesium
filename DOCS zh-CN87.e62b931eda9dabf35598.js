...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/tools/vc-drawings.md?vue&type=template&id=6cd4e698

var vc_drawingsvue_type_template_id_6cd4e698_hoisted_1 = {
  class: "content element-doc"
};

var vc_drawingsvue_type_template_id_6cd4e698_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["l" /* createStaticVNode */])("<h2 id=\"vcdrawings\"><a class=\"header-anchor\" href=\"#vcdrawings\">¶</a> VcDrawings</h2><p>加载绘制工具组件，目前包含点、线、面绘制工具，其他的后续再增加。</p><p><strong>注意：</strong> 需要引入样式文件: <code>import &#39;vue-cesium/lib/theme-default/index.css&#39;;</code></p><div class=\"tip\"><p>提示：3.0 版本已将绘制组件重构成一个组件，简约的同时支持自定义风格。</p><p>ctrl + 右键取消绘制。</p></div><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>绘制组件的基础用法。</p>", 6);

var vc_drawingsvue_type_template_id_6cd4e698_hoisted_8 = /*#__PURE__*/Object(vue_esm_browser["n" /* createVNode */])("div", null, [/*#__PURE__*/Object(vue_esm_browser["n" /* createVNode */])("p", null, [/*#__PURE__*/Object(vue_esm_browser["m" /* createTextVNode */])("使用 "), /*#__PURE__*/Object(vue_esm_browser["n" /* createVNode */])("code", null, "vc-drawings"), /*#__PURE__*/Object(vue_esm_browser["m" /* createTextVNode */])(" 标签在三维球上添加绘制工具。")])], -1);
...
function vc_drawingsvue_type_template_id_6cd4e698_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["i" /* createBlock */])("section", vc_drawingsvue_type_template_id_6cd4e698_hoisted_1, [vc_drawingsvue_type_template_id_6cd4e698_hoisted_2, Object(vue_esm_browser["n" /* createVNode */])(_component_demo_block, null, {
    ...
    default: Object(vue_esm_browser["db" /* withCtx */])(function () {
      return [vc_drawingsvue_type_template_id_6cd4e698_hoisted_8];
    }),
    _: 1
  }), _hoisted_10, Object(vue_esm_browser["n" /* createVNode */])(_component_right_nav)]);
}
// CONCATENATED MODULE: ./website/docs/zh-CN/tools/vc-drawings.md?vue&type=template&id=6cd4e698
...
/* harmony default export */ var vc_drawingsvue_type_script_lang_ts = ({
  ...
  components: {
    "vue-cesium-demo0": function () {
      ...
      var _hoisted_7 = /*#__PURE__*/_createTextVNode("地形");

      var _hoisted_8 = /*#__PURE__*/_createTextVNode("贴地");
      ...
      var democomponentExport = {
        ...
        methods: {
          ...
          drawEvt: function drawEvt(e, viewer) {
            var restoreCursor = getComputedStyle(viewer.canvas).cursor;
            console.log(e, this.restoreCursorMove);
          ...
          activeEvt: function activeEvt(e, viewer) {
            console.log(e);
            viewer.canvas.setAttribute('style', "cursor: " + (e.isActive ? 'crosshair' : 'auto'));
          ...
          editorEvt: function editorEvt(e, viewer) {
            if (e.type === 'move') {
              var restoreCursor = getComputedStyle(viewer.canvas).cursor;
              viewer.canvas.setAttribute('style', 'cursor: move');
              this.drawing = true;
          ...
          mouseEvt: function mouseEvt(e, viewer) {
            var restoreCursor = getComputedStyle(viewer.canvas).cursor;
...
vc_drawingsvue_type_script_lang_ts.render = vc_drawingsvue_type_template_id_6cd4e698_render
