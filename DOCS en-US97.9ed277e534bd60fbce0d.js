...
const _hoisted_9 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<table><thead><tr><th>Name</th><th>Type</th><th>Default</th><th>Description</th></tr></thead><tbody><tr><td>url</td><td>string|Cesium.Resource</td><td></td><td><code>required</code> The URL of the VR-TheWorld TileMap.</td></tr><tr><td>token</td><td>string</td><td></td><td><code>optional</code> The ellipsoid. If this parameter is not specified, the WGS84 ellipsoid is used.</td></tr><tr><td>ellipsoid</td><td>Cesium.Ellipsoid</td><td></td><td><code>optional</code> A credit for the data source, which is displayed on the canvas.</td></tr></tbody></table>", 1);
...
function vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_hoisted_1, [Object(vue_esm_browser["createVNode"])(_component_app_heading, {
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_hoisted_2, Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vcterrainprovidervrtheworld"
    })]),
    _: 1
  }), vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_hoisted_3, Object(vue_esm_browser["createVNode"])(_component_app_heading, {
    id: "basic-usage",
    tabindex: "-1",
    content: "Basic usage",
    href: "#basic-usage",
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_hoisted_4, Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#basic-usage"
    })]),
    _: 1
...
// CONCATENATED MODULE: ./website/docs/en-US/providers/vc-terrain-provider-vr-theworld.md?vue&type=template&id=55fb5d42
...
vc_terrain_provider_vr_theworldvue_type_script_lang_ts.render = vc_terrain_provider_vr_theworldvue_type_template_id_55fb5d42_render
