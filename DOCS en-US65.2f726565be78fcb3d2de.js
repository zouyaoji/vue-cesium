...
const _hoisted_3 = /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("p", null, "Basic usage of VcCollectionBillboard component.", -1);
...
const _hoisted_11 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<table><thead><tr><th>Name</th><th>Type</th><th>Default</th><th>Description</th><th>Accepted Values</th></tr></thead><tbody><tr><td>alignedAxis</td><td>VcPosition|Array</td><td><code>{x: 0, y: 0, z: 0}</code></td><td><code>optional</code> The aligned axis in world space. The aligned axis is the unit vector that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector.</td><td></td></tr><tr><td>color</td><td>VcColor|string|Array</td><td><code>&#39;white&#39;</code></td><td><code>optional</code> The color that is multiplied with the billboard&#39;s texture.</td><td></td></tr><tr><td>disableDepthTestDistance</td><td>number</td><td></td><td><code>optional</code> The distance from the camera at which to disable the depth test to, for example, prevent clipping against terrain. When set to zero, the depth test is always applied. When set to Number.POSITIVE_INFINITY, the depth test is never applied.</td><td></td></tr><tr><td>distanceDisplayCondition</td><td>VcDistanceDisplayCondition|Array</td><td></td><td><code>optional</code> The condition specifying at what distance from the camera that this billboard will be displayed.</td><td></td></tr><tr><td>eyeOffset</td><td>VcPosition|Array</td><td><code>{x: 0, y: 0, z: 0}</code></td><td><code>optional</code> The 3D Cartesian offset applied to this billboard in eye coordinates.</td><td></td></tr><tr><td>height</td><td>number</td><td></td><td><code>optional</code> The height for the billboard. If undefined, the image height will be used.</td><td></td></tr><tr><td>heightReference</td><td>number</td><td><code>0</code></td><td><code>optional</code> The height reference of this billboard. <strong>NONE: 0, CLAMP_TO_GROUND: 1, RELATIVE_TO_GROUND: 2</strong></td><td>0/1/2</td></tr><tr><td>horizontalOrigin</td><td>number</td><td><code>0</code></td><td><code>optional</code> The horizontal origin of this billboard, which determines if the billboard is to the left, center, or right of its anchor position. <strong>CENTER: 0, LEFT: 1, RIGHT: -1</strong></td><td>0/1/2</td></tr><tr><td>id</td><td>*</td><td></td><td><code>optional</code> The user-defined object returned when the billboard is picked.</td><td></td></tr><tr><td>image</td><td>string</td><td></td><td><code>optional</code> The image to be used for this billboard. If a texture has already been created for the given image, the existing texture is used.</td><td></td></tr><tr><td>pixelOffset</td><td>VcCartesian2|Array</td><td><code>{x: 0, y: 0}</code></td><td><code>optional</code> The pixel offset in screen space from the origin of this billboard.</td><td></td></tr><tr><td>pixelOffsetScaleByDistance</td><td>VcNearFarScalar|Array</td><td></td><td><code>optional</code> The near and far pixel offset scaling properties of a Billboard based on the billboard&#39;s distance from the camera.</td><td></td></tr><tr><td>position</td><td>VcPosition|Array</td><td></td><td><code>optional</code> The position of this billboard.</td><td></td></tr><tr><td>rotation</td><td>number</td><td><code>0</code></td><td><code>optional</code> The rotation angle in radians.</td><td></td></tr><tr><td>scale</td><td>number</td><td><code>1.0</code></td><td><code>optional</code> The uniform scale that is multiplied with the billboard&#39;s image size in pixels.</td><td></td></tr><tr><td>scaleByDistance</td><td>VcNearFarScalar|Array</td><td></td><td><code>optional</code> The near and far scaling properties of a Billboard based on the billboard&#39;s distance from the camera.</td><td></td></tr><tr><td>show</td><td>boolean</td><td><code>true</code></td><td><code>optional</code> Determines if this billboard will be shown. Use this to hide or show a billboard, instead of removing it and re-adding it to the collection.</td><td></td></tr><tr><td>sizeInMeters</td><td>boolean</td><td></td><td><code>optional</code> Determines if the billboard size is in meters or pixels. true to size the billboard in meters; otherwise, the size is in pixels.</td><td></td></tr><tr><td>translucencyByDistance</td><td>VcNearFarScalar|Array</td><td></td><td><code>optional</code> The near and far translucency properties of a Billboard based on the billboard&#39;s distance from the camera.</td><td></td></tr><tr><td>verticalOrigin</td><td>number</td><td><code>0</code></td><td><code>optional</code> The vertical origin of this billboard, which determines if the billboard is to the above, below, or at the center of its anchor position. <strong>CENTER: 0, BOTTOM: 1, BASELINE: 2, TOP: -1</strong></td><td>0/1/2/-1</td></tr><tr><td>width</td><td>number</td><td></td><td><code>optional</code> The width for the billboard. If undefined, the image width will be used.</td><td></td></tr><tr><td>enableMouseEvent</td><td>boolean</td><td><code>true</code></td><td><code>optional</code> Specify whether the mouse event takes effect.</td><td></td></tr></tbody></table>", 1);
const _hoisted_12 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<table><thead><tr><th>Name</th><th>Parameters</th><th>Description</th></tr></thead><tbody><tr><td>beforeLoad</td><td>(instance: VcComponentInternalInstance)</td><td>Triggers before the cesiumObject is loaded.</td></tr><tr><td>ready</td><td>(readyObj: VcReadyObject)</td><td>Triggers when the cesiumObject is successfully loaded.</td></tr><tr><td>destroyed</td><td>(instance: VcComponentInternalInstance)</td><td>Triggers when the cesiumObject is destroyed.</td></tr><tr><td>mousedown</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse is pressed on this primitive.</td></tr><tr><td>mouseup</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse bounces up on this primitive.</td></tr><tr><td>click</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse clicks on the primitive.</td></tr><tr><td>clickout</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse clicks outside the primitive.</td></tr><tr><td>dblclick</td><td>(evt: VcPickEvent)</td><td>Triggers when the left mouse button double-clicks the primitive.</td></tr><tr><td>mousemove</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse moves on this primitive.</td></tr><tr><td>mouseover</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse moves to this primitive.</td></tr><tr><td>mouseout</td><td>(evt: VcPickEvent)</td><td>Triggers when the mouse moves out of this primitive.</td></tr></tbody></table>", 1);
function vc_collection_billboardvue_type_template_id_4b43ab74_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", _hoisted_1, [Object(vue_esm_browser["createVNode"])(_component_app_heading, {
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("VcCollectionBillboard "), Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vccollectionbillboard"
    })]),
    _: 1
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("VcBillboard "), Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vcbillboard"
    })]),
    _: 1
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("VcBillboard Props "), Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vcbillboard-props"
    })]),
    _: 1
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("VcBillboard Events "), Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vcbillboard-events"
    })]),
    _: 1
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("BillboardCollection")]),
    _: 1
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [Object(vue_esm_browser["createTextVNode"])("Billboard")]),
    _: 1
  })])])]), Object(vue_esm_browser["createVNode"])(_component_right_nav)]);
}
// CONCATENATED MODULE: ./website/docs/en-US/primitives/vc-collection-billboard.md?vue&type=template&id=4b43ab74
...
vc_collection_billboardvue_type_script_lang_ts.render = vc_collection_billboardvue_type_template_id_4b43ab74_render
