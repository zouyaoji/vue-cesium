...
function vc_graphics_wallvue_type_template_id_9a48c600_render(_ctx, _cache, $props, $setup, $data, $options) {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/graphics/vc-graphics-wall.md?vue&type=template&id=9a48c600
              ...
              default: _withCtx(() => [_createVNode(_component_vc_graphics_wall, {
                ...
                material: {
                  fabric: {
                    type: 'VcLineFlow',
                    uniforms: {
                      image: '/images/textures/arrow.png',
                      color: 'yellow',
                      repeat: {
                        x: 30,
                        y: 1
...
vc_graphics_wallvue_type_script_lang_ts.render = vc_graphics_wallvue_type_template_id_9a48c600_render
