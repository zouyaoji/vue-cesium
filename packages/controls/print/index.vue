<template>
  ...
  >
    ...
    >
      ...
      >
        <strong>{{ t('vc.navigation.print.printTip') }}</strong>
      </vc-tooltip>
    </vc-btn>
  </div>
</template>
...
export default defineComponent({
  name: 'VcPrint',
  components: { VcTooltip, VcBtn, VcIcon },
  props: defaultProps,
  ...
  setup(props, ctx) {
    ...
    const rootStyle = computed(() => {
      ...
      if (parentInstance.proxy.$options.name !== 'VcNavigation') {
