...
export default function (props, { emit }, vcInstance: VcComponentInternalInstance) {
  ...
  let rotateEastMouseUpFunction: AnyFunction = undefined
  let rotateEastTickFunction: AnyFunction = undefined
  ...
  let tiltMouseMoveFunction: AnyFunction = undefined
  let tiltMouseUpFunction: AnyFunction = undefined
  let isTilting = false
  let tiltFrame: any = {}
