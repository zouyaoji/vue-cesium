...
export default defineComponent({
  ...
  setup (props: ExtractPropTypes<typeof defaultProps>, ctx) {
    ...
    const compassOptions = computed(
      () => Object.assign({}, defaultOptions.compassOpts, props.compassOpts)
    )
    const zoomControlOptions = computed(
      () => Object.assign({}, defaultOptions.zoomOpts, props.zoomOpts)
    )
    const printViewOptions = computed(
      () => Object.assign({}, defaultOptions.printOpts, props.printOpts)
    )
    const myLocationOptions = computed(
      () => Object.assign({}, defaultOptions.locationOpts, props.locationOpts)
    )
    const otherControlOptions = computed(
      () => Object.assign({}, defaultOptions.otherOpts, props.otherOpts)
    )
