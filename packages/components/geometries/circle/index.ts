...
import { center, ellipsoid, extrudedHeight, granularity, height, radius, stRotation, vertexFormat } from '@vue-cesium/utils/cesium-props'
...
export interface VcGeometryCircleProps {
  /**
