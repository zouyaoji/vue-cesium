...
import { ellipsoid, granularity, maximumHeights, minimumHeights, positions, vertexFormat } from '@vue-cesium/utils/cesium-props'
...
export interface VcGeometryWallProps {
  /**
