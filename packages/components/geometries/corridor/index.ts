...
import { cornerType, ellipsoid, extrudedHeight, granularity, height, positions, vertexFormat, width } from '@vue-cesium/utils/cesium-props'
...
export interface VcGeometryCorridorProps {
  /**
