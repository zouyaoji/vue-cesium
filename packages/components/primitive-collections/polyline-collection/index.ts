...
import type { VcPolylineProps } from '../polyline'
import { usePrimitiveCollections } from '@vue-cesium/composables'
import { debugShowBoundingVolume, enableMouseEvent, modelMatrix, show } from '@vue-cesium/utils/cesium-props'
...
export interface VcCollectionPolylineProps {
  /**
