...
import { makeMaterial, makeCartesian2, getGeodesicDistance } from '@vue-cesium/utils/cesium-helpers'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const updateComponents = (polyline: DistanceMeasurementPolylineSegment) => {
      ...
      if (
        !(Cartesian3.equalsEpsilon(xyPoint, endPoint, CesiumMath.EPSILON10) && Cartesian3.equalsEpsilon(xyPoint, startPoint, CesiumMath.EPSILON10))
      ) {
