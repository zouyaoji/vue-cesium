...
export declare type VcBtnOptions = {
    name?: string;
    size?: string;
    color?: string;
    background?: string;
...
declare type VcComponentPublicInstance = ComponentPublicInstance<{
...
export { AnyFunction, AnyObject, CameraObj, ReadyObj, VcComponentInternalInstance, VcComponentPublicInstance, VcViewerProvider, CesiumMembersEvent, Cartesian2Option, Cartesian3Option, Cartesian4Option, CartographicInDegreeOption, PolygonHierarchyOption, NearFarScalarOption, DistanceDisplayConditionOption, ColorInByteOption, MaterialOption, RectangleInDegreeOption, BoundingRectangleOption, PlaneOption, TranslationRotationScaleOption, NavigationOption, HeadingPitchRollOption };
export type { Cesium };
