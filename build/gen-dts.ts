  ...
  for (const sourceFile of sourceFiles) {
    ...
    for (const outputFile of emitOutput.getOutputFiles()) {
      ...
      await fs.promises.writeFile(
        ...
        outputFile
          .getText()
          .replace(new RegExp('@vue-cesium/components', 'g'), 'vue-cesium/es')
          .replace(new RegExp('@vue-cesium/theme-default', 'g'), 'vue-cesium/theme-default')
          .replace(new RegExp('@vue-cesium', 'g'), 'vue-cesium/es'),
        'utf8'
      )
