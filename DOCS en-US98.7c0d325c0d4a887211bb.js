...
// CONCATENATED MODULE: ./node_modules/.pnpm/babel-loader@8.2.3_bcd6ea64369259a9a094ff5ba7188bb6/node_modules/babel-loader/lib!./node_modules/.pnpm/vue-loader@16.5.0_2a2707c7f6fb238ee6d53f3ae7e6e321/node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/.pnpm/vue-loader@16.5.0_2a2707c7f6fb238ee6d53f3ae7e6e321/node_modules/vue-loader/dist??ref--3-0!./website/md-loader!./website/docs/en-US/vc-viewer.md?vue&type=template&id=97fce6ee

const vc_viewervue_type_template_id_97fce6ee_hoisted_1 = {
  class: "content vue-cesium-doc"
};

const vc_viewervue_type_template_id_97fce6ee_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["createTextVNode"])("VcViewer ");

const vc_viewervue_type_template_id_97fce6ee_hoisted_3 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<p>The basic component used to build the <code>Cesium</code> application is essentially a DOM node initialized by <code>Cesium.Viewer</code>, which is used to mount other DOM nodes or components.</p><p><strong>Note:</strong> Other components of <code>vue-cesium</code> or custom components composed of them need to be placed under this component to load normally. After the initialization is complete, you can obtain the returned <code>Cesium</code> and <code>Viewer</code> instances in the <code>ready</code> event for Cesium API development, or use <code>ref</code> to obtain the component&#39;s <code>createPromise</code> object to get the Viewer instance.</p>", 2);
...
const _hoisted_65 = /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("tr", null, [/*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("td", null, "camera"), /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("td", null, "Object: VcCamera"), /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("td"), /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("td", null, [/*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("code", null, "optional"), /*#__PURE__*/Object(vue_esm_browser["createTextVNode"])(" Scene camera position. Default positioning to China worldwide. "), /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("strong", null, "structure: { position: { lng: number, lat: number, height: number }, heading: number, pitch: number, roll: number }")]), /*#__PURE__*/Object(vue_esm_browser["createElementVNode"])("td")], -1);

const _hoisted_66 = /*#__PURE__*/Object(vue_esm_browser["createTextVNode"])("Events ");

const _hoisted_67 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<table><thead><tr><th>Name</th><th>Parameters</th><th>Description</th><th>Source</th></tr></thead><tbody><tr><td>cesiumReady</td><td>(e: typeof Cesium)</td><td>Triggers when CesiumJS is successfully loaded.</td><td>-</td></tr><tr><td>beforeLoad</td><td>(instance: VcComponentInternalInstance)</td><td>Triggers before vc-viewer is loaded.</td><td>-</td></tr><tr><td>ready</td><td>(readyObj: VcReadyObject)</td><td>Triggers when vc-viewer is successfully loaded.</td><td>-</td></tr><tr><td>destroyed</td><td>(instance: VcComponentInternalInstance)</td><td>Triggers when vc-viewer is destroyed.</td><td>-</td></tr><tr><td>viewerWidgetResized</td><td>(e: ViewerWidgetResizedEvent)</td><td>Triggers when a component changes on vc-viewer.</td><td>-</td></tr><tr><td>------</td><td>----</td><td>----</td><td>---</td></tr><tr><td>selectedEntityChanged</td><td>(entity: Cesium.Entity)</td><td>Gets the event that is raised when the selected entity changes.</td><td>Viewer</td></tr><tr><td>trackedEntityChanged</td><td>(entity: Cesium.Entity)</td><td>Gets the event that is raised when the tracked entity changes.</td><td>Viewer</td></tr><tr><td>layerAdded</td><td>(imageryLayer: Cesium.ImageryLayer, index: number)</td><td>An event that is raised when a layer is added to the collection. Event handlers are passed the layer that was added and the index at which it was added.</td><td>Viewer.imageryLayers</td></tr><tr><td>layerMoved</td><td>(imageryLayer: Cesium.ImageryLayer, newIndex: number, oldIndex: number)</td><td>An event that is raised when a layer changes position in the collection. Event handlers are passed the layer that was moved, its new index after the move, and its old index prior to the move.</td><td>Viewer.imageryLayers</td></tr><tr><td>layerRemoved</td><td>(imageryLayer: Cesium.ImageryLayer, index: number)</td><td>An event that is raised when a layer is removed from the collection. Event handlers are passed the layer that was removed and the index from which it was removed.</td><td>Viewer.imageryLayers</td></tr><tr><td>layerShownOrHidden</td><td>(imageryLayer: Cesium.ImageryLayer, index: number, show: boolean)</td><td>An event that is raised when a layer is shown or hidden by setting the ImageryLayer#show property. Event handlers are passed a reference to this layer, the index of the layer in the collection, and a flag that is true if the layer is now shown or false if it is now hidden.</td><td>iewer.imageryLayers</td></tr><tr><td>dataSourceAdded</td><td>(collection: Cesium.DataSourceCollection, dataSource: VcDatasource)</td><td>An event that is raised when a data source is added to the collection. Event handlers are passed the data source that was added.</td><td>Viewer.dataSources</td></tr><tr><td>dataSourceMoved</td><td>(dataSource: VcDatasource, newIndex: number, oldIndex: number)</td><td>An event that is raised when a data source changes position in the collection. Event handlers are passed the data source that was moved, its new index after the move, and its old index prior to the move.</td><td>Viewer.dataSources</td></tr><tr><td>dataSourceRemoved</td><td>(collection: Cesium.DataSourceCollection, dataSource: VcDatasource)</td><td>An event that is raised when a data source is removed from the collection. Event handlers are passed the data source that was removed.</td><td>Viewer.entities</td></tr><tr><td>collectionChanged</td><td>(collection: Cesium.EntityCollection, addedArray: Array&lt;Cesium.Entity&gt;, removedArray: Array&lt;Cesium.Entity&gt;, changedArray: Array&lt;Cesium.Entity&gt;)</td><td>Gets the event that is fired when entities are added or removed from the collection. The generated event is a EntityCollection.collectionChangedEventCallback.</td><td>Viewer.entities</td></tr><tr><td>morphComplete</td><td>(transitioner: any, preceneModeMode: Cesium.SceneMode, sceneMode: Cesium.SceneMode, wasMorphing: boolean)</td><td>The event fired at the completion of a scene transition.</td><td>Viewer.scene</td></tr><tr><td>morphStart</td><td>(transitioner: any, preceneModeMode: Cesium.SceneMode, sceneMode: Cesium.SceneMode, wasMorphing: boolean)</td><td>The event fired at the beginning of a scene transition.</td><td>Viewer.scene</td></tr><tr><td>postRender</td><td>(scene: Cesium.Scene, time: Cesium.JulianDate)</td><td>Gets the event that will be raised immediately after the scene is rendered. Subscribers to the event receive the Scene instance as the first parameter and the current time as the second parameter.</td><td>Viewer.scene</td></tr><tr><td>preRender</td><td>(scene: Cesium.Scene, time: Cesium.JulianDate)</td><td>Gets the event that will be raised after the scene is updated and immediately before the scene is rendered. Subscribers to the event receive the Scene instance as the first parameter and the current time as the second parameter.</td><td>Viewer.scene</td></tr><tr><td>postUpdate</td><td>(scene: Cesium.Scene, time: Cesium.JulianDate)</td><td>Gets the event that will be raised immediately after the scene is updated and before the scene is rendered. Subscribers to the event receive the Scene instance as the first parameter and the current time as the second parameter.</td><td>Viewer.scene</td></tr><tr><td>preUpdate</td><td>(scene: Cesium.Scene, time: Cesium.JulianDate)</td><td>Gets the event that will be raised before the scene is updated or rendered. Subscribers to the event receive the Scene instance as the first parameter and the current time as the second parameter.</td><td>Viewer.scene</td></tr><tr><td>renderError</td><td>(scene: Cesium.Scene, error: any)</td><td>Gets the event that will be raised when an error is thrown inside the render function. The Scene instance and the thrown error are the only two parameters passed to the event handler. By default, errors are not rethrown after this event is raised, but that can be changed by setting the rethrowRenderErrors property.</td><td>Viewer.scene</td></tr><tr><td>terrainProviderChanged</td><td>(provider: VcTerrainProvider)</td><td>Gets an event that&#39;s raised when the terrain provider is changed.</td><td>Viewer.scene</td></tr><tr><td>changed</td><td>(percent: number)</td><td>Gets the event that will be raised when the camera has changed by percentageChanged.</td><td>Viewer.camera</td></tr><tr><td>moveEnd</td><td>()</td><td>Gets the event that will be raised when the camera has stopped moving.</td><td>Viewer.camera</td></tr><tr><td>moveStart</td><td>()</td><td>Gets the event that will be raised at when the camera starts to move.</td><td>Viewer.camera</td></tr><tr><td>onStop</td><td>(clock: Cesium.Clock)</td><td>An Event that is fired whenever Clock#stopTime is reached.</td><td>Viewer.clock</td></tr><tr><td>onTick</td><td>(clock: Cesium.Clock)</td><td>An Event that is fired whenever Clock#tick is called.</td><td>Viewer.clock</td></tr><tr><td>errorEvent</td><td>(tileProviderError: any)</td><td>Gets an event that is raised when the terrain provider encounters an asynchronous error.. By subscribing to the event, you will be notified of the error and can potentially recover from it. Event listeners are passed an instance of TileProviderError.</td><td>Viewer.terrainProvider</td></tr><tr><td>cameraClicked</td><td>(viewModel: Cesium.InfoBoxViewModel)</td><td>Gets an Event that is fired when the user clicks the camera icon.</td><td>Viewer.infoBox.viewModel</td></tr><tr><td>closeClicked</td><td>(viewModel: Cesium.InfoBoxViewModel)</td><td>Gets an Event that is fired when the user closes the info box.</td><td>Viewer.infoBox.viewModel</td></tr><tr><td>leftClick</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse left click event.</td><td>ScreenSpaceEventType</td></tr><tr><td>leftDoubleClick</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse left double click event.</td><td>ScreenSpaceEventType</td></tr><tr><td>leftDown</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse left button down event.</td><td>ScreenSpaceEventType</td></tr><tr><td>leftUp</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse left button up event.</td><td>ScreenSpaceEventType</td></tr><tr><td>middleClick</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse middle click event.</td><td>ScreenSpaceEventType</td></tr><tr><td>middleDown</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse middle button down event.</td><td>ScreenSpaceEventType</td></tr><tr><td>middleUp</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse middle button up event.</td><td>ScreenSpaceEventType</td></tr><tr><td>mouseMove</td><td>{startPosition: point, endPosition: point}</td><td>Represents a mouse move event.</td><td>ScreenSpaceEventType</td></tr><tr><td>pinchEnd</td><td>()</td><td>Represents the end of a two-finger event on a touch surface.</td><td>ScreenSpaceEventType</td></tr><tr><td>pinchMove</td><td>(evt: { distance: { startPosition: Cesium.Cartesian2; endPosition: Cesium.Cartesian2 } angleAndHeight: { startPosition: Cesium.Cartesian2 ;endPosition: Cesium.Cartesian2 }})</td><td>Represents a change of a two-finger event on a touch surface.</td><td>ScreenSpaceEventType</td></tr><tr><td>pinchStart</td><td>(evt: { position1: Cesium.Cartesian2; position2: Cesium.Cartesian2; })</td><td>Represents the start of a two-finger event on a touch surface.</td><td>ScreenSpaceEventType</td></tr><tr><td>rightClick</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse right click event.</td><td>ScreenSpaceEventType</td></tr><tr><td>rightDown</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse left button down event.</td><td>ScreenSpaceEventType</td></tr><tr><td>rightUp</td><td>(evt: { position: Cesium.Cartesian2; })</td><td>Represents a mouse right button up event.</td><td>ScreenSpaceEventType</td></tr><tr><td>wheel</td><td>(delta: number)</td><td>Represents a mouse wheel event.</td><td>ScreenSpaceEventType</td></tr><tr><td>imageryLayersUpdatedEvent</td><td>()</td><td>Gets an event that&#39;s raised when an imagery layer is added, shown, hidden, moved, or removed.</td><td>Viewer.scene.globe</td></tr><tr><td>tileLoadProgressEvent</td><td>(length: number)</td><td>Gets an event that&#39;s raised when the length of the tile load queue has changed since the last render frame. When the load queue is empty, all terrain and imagery for the current view have been loaded. The event passes the new length of the tile load queue.</td><td>Viewer.scene.globe</td></tr></tbody></table>", 1);
...
function vc_viewervue_type_template_id_97fce6ee_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", vc_viewervue_type_template_id_97fce6ee_hoisted_1, [Object(vue_esm_browser["createVNode"])(_component_app_heading, {
    id: "vcviewer",
    tabindex: "-1",
    content: "VcViewer",
    href: "#vcviewer",
    ...
    default: Object(vue_esm_browser["withCtx"])(() => [vc_viewervue_type_template_id_97fce6ee_hoisted_2, Object(vue_esm_browser["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#vcviewer"
    })]),
    _: 1
  }), vc_viewervue_type_template_id_97fce6ee_hoisted_3, Object(vue_esm_browser["createVNode"])(_component_app_heading, {
    id: "basic-usage",
    tabindex: "-1",
    content: "Basic usage",
    href: "#basic-usage",
...
// CONCATENATED MODULE: ./website/docs/en-US/vc-viewer.md?vue&type=template&id=97fce6ee
...
vc_viewervue_type_script_lang_ts.render = vc_viewervue_type_template_id_97fce6ee_render
