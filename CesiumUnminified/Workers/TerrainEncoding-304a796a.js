...
define([
...
], function (exports, Transforms, Matrix2, RuntimeError, when, AttributeCompression, ComponentDatatype) {
  'use strict'
  ...
  function isScaledSpacePointVisible(occludeeScaledSpacePosition, cameraPositionInScaledSpace, distanceToLimbInScaledSpaceSquared) {
    ...
    var vt = Matrix2.Cartesian3.subtract(occludeeScaledSpacePosition, cv, scratchCartesian)
    ...
    var isOccluded =
      vhMagnitudeSquared < 0
        ? vtDotVc > 0
        : vtDotVc > vhMagnitudeSquared && (vtDotVc * vtDotVc) / Matrix2.Cartesian3.magnitudeSquared(vt) > vhMagnitudeSquared
    return !isOccluded
  }
  ...
  function computeMagnitude(ellipsoid, position, scaledSpaceDirectionToPoint) {
    ...
    var direction = Matrix2.Cartesian3.divideByScalar(scaledSpacePosition, magnitude, directionScratch)
    ...
    var sinAlpha = Matrix2.Cartesian3.magnitude(Matrix2.Cartesian3.cross(direction, scaledSpaceDirectionToPoint, direction))
  ...
  function magnitudeToPoint(scaledSpaceDirectionToPoint, resultMagnitude, result) {
    ...
    return Matrix2.Cartesian3.multiplyByScalar(scaledSpaceDirectionToPoint, resultMagnitude, result)
  }
  ...
  TerrainExaggeration.getPosition = function (position, ellipsoid, terrainExaggeration, terrainExaggerationRelativeHeight, result) {
    ...
    return Matrix2.Cartesian3.fromRadians(cartographic.longitude, cartographic.latitude, newHeight, ellipsoid, result)
  }
  ...
  function TerrainEncoding(
    ...
    if (when.defined(axisAlignedBoundingBox) && when.defined(minimumHeight) && when.defined(maximumHeight) && when.defined(fromENU)) {
      ...
      var dimensions = Matrix2.Cartesian3.subtract(maximum, minimum, cartesian3DimScratch)
