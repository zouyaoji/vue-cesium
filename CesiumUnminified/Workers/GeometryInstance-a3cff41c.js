...
define(['exports', './when-4bbc8319', './RuntimeError-346a3079', './Matrix2-91d5b6af'], function (exports, when, RuntimeError, Matrix2) {
  'use strict'
  ...
  function GeometryInstance(options) {
     ...
     */
    this.modelMatrix = Matrix2.Matrix4.clone(when.defaultValue(options.modelMatrix, Matrix2.Matrix4.IDENTITY))
