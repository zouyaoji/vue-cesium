...
define([
   ...
   * @type {Number}
   */
  BoxGeometry.packedLength = 2 * Matrix2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 1
  ...
  BoxGeometry.pack = function (value, array, startingIndex) {
    ...
    Matrix2.Cartesian3.pack(value._maximum, array, startingIndex + Matrix2.Cartesian3.packedLength)
    VertexFormat.VertexFormat.pack(value._vertexFormat, array, startingIndex + 2 * Matrix2.Cartesian3.packedLength)
    array[startingIndex + 2 * Matrix2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = when.defaultValue(
  ...
  BoxGeometry.unpack = function (array, startingIndex, result) {
    ...
    var vertexFormat = VertexFormat.VertexFormat.unpack(array, startingIndex + 2 * Matrix2.Cartesian3.packedLength, scratchVertexFormat)
    var offsetAttribute = array[startingIndex + 2 * Matrix2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength]
