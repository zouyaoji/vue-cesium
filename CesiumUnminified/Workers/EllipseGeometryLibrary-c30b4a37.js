...
define(['exports', './Matrix2-91d5b6af', './ComponentDatatype-f194c48b', './Transforms-86b6fa28'], function (
  exports,
  Matrix2,
  ComponentDatatype,
  Transforms
  ...
  EllipseGeometryLibrary.raisePositionsToHeight = function (positions, options, extrude) {
    ...
    for (var i = 0; i < length; i += 3) {
      ...
      var scaledNormal = Matrix2.Cartesian3.multiplyByScalar(normal, height, scratchCartesian3)
    ...
    for (i = 1; i < numPts + 1; ++i) {
      ...
      if (addFillPositions) {
        ...
        for (j = 1; j < numInterior - 1; ++j) {
          t = j / (numInterior - 1)
          interiorPosition = Matrix2.Cartesian3.lerp(position, reflectedPosition, t, scratchCartesian3)
