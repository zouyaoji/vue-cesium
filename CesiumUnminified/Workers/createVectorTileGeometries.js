...
define(['./when-cbf8cd21', './Check-35e1a91d', './Math-d4357f39', './Cartesian2-d70cd429', './Transforms-2e432899', './RuntimeError-f4c64df1', './WebGLConstants-95ceb4e9', './ComponentDatatype-607c9a0c', './GeometryAttribute-9bd671cb', './GeometryAttributes-90846c5f', './IndexDatatype-573b6d9d', './createTaskProcessorWorker', './GeometryOffsetAttribute-9c676324', './VertexFormat-fe64931e', './BoxGeometry-d5c846b8', './CylinderGeometryLibrary-88e64f9c', './CylinderGeometry-2f6e28f2', './EllipsoidGeometry-38a5320c', './Color-58dcd8fb'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, createTaskProcessorWorker, GeometryOffsetAttribute, VertexFormat, BoxGeometry, CylinderGeometryLibrary, CylinderGeometry, EllipsoidGeometry, Color) { 'use strict';
