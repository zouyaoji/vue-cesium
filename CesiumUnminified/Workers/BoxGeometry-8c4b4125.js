define([
  ...
  BoxGeometry.pack = function (value, array, startingIndex) {
    ...
    array[startingIndex + 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = defaultValue.defaultValue(
  ...
  BoxGeometry.unpack = function (array, startingIndex, result) {
    ...
    const max = Matrix3.Cartesian3.unpack(array, startingIndex + Matrix3.Cartesian3.packedLength, scratchMax)
    const vertexFormat = VertexFormat.VertexFormat.unpack(array, startingIndex + 2 * Matrix3.Cartesian3.packedLength, scratchVertexFormat)
    const offsetAttribute = array[startingIndex + 2 * Matrix3.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength]
  ...
  BoxGeometry.createGeometry = function (boxGeometry) {
    ...
    if (defaultValue.defined(boxGeometry._offsetAttribute)) {
      ...
      const offsetValue = boxGeometry._offsetAttribute === GeometryOffsetAttribute.GeometryOffsetAttribute.NONE ? 0 : 1
