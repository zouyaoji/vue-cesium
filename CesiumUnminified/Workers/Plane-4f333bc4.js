...
define(['exports', './Matrix2-91d5b6af', './RuntimeError-346a3079', './when-4bbc8319', './ComponentDatatype-f194c48b'], function (
  ...
  function Plane(normal, distance) {
    ...
    if (!ComponentDatatype.CesiumMath.equalsEpsilon(Matrix2.Cartesian3.magnitude(normal), 1.0, ComponentDatatype.CesiumMath.EPSILON6)) {
  ...
  Plane.projectPointOntoPlane = function (plane, point, result) {
    ...
    var scaledNormal = Matrix2.Cartesian3.multiplyByScalar(plane.normal, pointDistance, scratchCartesian)
  ...
  Plane.transform = function (plane, transform, result) {
    ...
    var transformedNormal = Matrix2.Cartesian3.fromCartesian4(planeAsCartesian4, scratchTransformNormal)

    planeAsCartesian4 = Matrix2.Cartesian4.divideByScalar(planeAsCartesian4, Matrix2.Cartesian3.magnitude(transformedNormal), planeAsCartesian4)
  ...
  Plane.equals = function (left, right) {
    ...
    return left.distance === right.distance && Matrix2.Cartesian3.equals(left.normal, right.normal)
  }
