...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/en-US/primitives/vc-collection-primitive.md?vue&type=template&id=f59798b0

var vc_collection_primitivevue_type_template_id_f59798b0_hoisted_1 = {
  class: "content element-doc"
};

var vc_collection_primitivevue_type_template_id_f59798b0_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["l" /* createStaticVNode */])("<h2 id=\"vccollectionprimitive\"><a class=\"header-anchor\" href=\"#vccollectionprimitive\">¶</a> VcCollectionPrimitive</h2><p>加载通用图元集合，相当于初始化一个 <code>Cesium.PrimitiveCollection</code> 实例。</p><div class=\"tip\"><p><code>vc-viewer</code> 初始化得到的 <code>Viewer</code> 实例自带的一个成员属性 <code>Scene.primitives(PrimitiveCollection)</code>。它可作为一切图元的父组件，如有需要也可以作为子集嵌套一层或多层。</p></div><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>通用图元集合组件的基础用法。</p>", 5);
...
function vc_collection_primitivevue_type_template_id_f59798b0_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["i" /* createBlock */])("section", vc_collection_primitivevue_type_template_id_f59798b0_hoisted_1, [vc_collection_primitivevue_type_template_id_f59798b0_hoisted_2, Object(vue_esm_browser["n" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/en-US/primitives/vc-collection-primitive.md?vue&type=template&id=f59798b0
...
vc_collection_primitivevue_type_script_lang_ts.render = vc_collection_primitivevue_type_template_id_f59798b0_render
