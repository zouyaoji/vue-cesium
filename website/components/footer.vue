  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://github.com/zouyaoji/vue-cesium" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
        <a href="https://github.com/zouyaoji/vue-cesium/releases" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
        <a href="https://github.com/zouyaoji/vue-cesium/blob/dev/FAQ.md" class="footer-main-link" target="_blank">{{ langConfig.faq }}</a>
        <a href="https://github.com/zouyaoji/vue-cesium-starter" class="footer-main-link" target="_blank">{{ langConfig.starter }}</a>
      </div>
      <div class="footer-main">
      ...
      <div class="footer-social">
        ...
        <a href="https://github.com/zouyaoji/vue-cesium" target="_blank">
          <i class="vc-icons vc-icons-github"></i>
        </a>
      </div>
    </div>
  </footer>
