...
$jscomp.polyfillIsolated = function (k, n, l, p) {
  ...
  null != n &&
    (k
      ? $jscomp.defineProperty($jscomp.polyfills, h, { configurable: true, writable: true, value: n })
      : n !== l &&
        ...
        $jscomp.defineProperty(p, $jscomp.propertyToPolyfillSymbol[h], { configurable: true, writable: true, value: n })))
}
$jscomp.polyfill(
  'Promise',
  function (k) {
    ...
    h.prototype.notifyUnhandledRejection_ = function () {
      ...
      'function' === typeof f
        ? (f = new f('unhandledrejection', { cancelable: true }))
        : 'function' === typeof q
        ? (f = new q('unhandledrejection', { cancelable: true }))
        : ((f = $jscomp.global.document.createEvent('CustomEvent')), f.initCustomEvent('unhandledrejection', false, true, f))
      f.promise = this
