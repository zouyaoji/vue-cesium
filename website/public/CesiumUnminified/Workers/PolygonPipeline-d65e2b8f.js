...
define([
...
], function (exports, Matrix2, RuntimeError, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, WebGLConstants) {
  'use strict'
  ...
  PolygonPipeline.computeArea2D = function (positions) {
    ...
    RuntimeError.Check.typeOf.number.greaterThanOrEquals('positions.length', positions.length, 3)
    //>>includeEnd('debug');
  ...
  PolygonPipeline.computeSubdivision = function (ellipsoid, positions, indices, granularity) {
    ...
    while (triangles.length > 0) {
      ...
      var v0 = Matrix2.Cartesian3.fromArray(subdividedPositions, i0 * 3, subdivisionV0Scratch)
      var v1 = Matrix2.Cartesian3.fromArray(subdividedPositions, i1 * 3, subdivisionV1Scratch)
      var v2 = Matrix2.Cartesian3.fromArray(subdividedPositions, i2 * 3, subdivisionV2Scratch)

      var s0 = Matrix2.Cartesian3.multiplyByScalar(Matrix2.Cartesian3.normalize(v0, subdivisionS0Scratch), radius, subdivisionS0Scratch)
      var s1 = Matrix2.Cartesian3.multiplyByScalar(Matrix2.Cartesian3.normalize(v1, subdivisionS1Scratch), radius, subdivisionS1Scratch)
      var s2 = Matrix2.Cartesian3.multiplyByScalar(Matrix2.Cartesian3.normalize(v2, subdivisionS2Scratch), radius, subdivisionS2Scratch)

      var g0 = Matrix2.Cartesian3.magnitudeSquared(Matrix2.Cartesian3.subtract(s0, s1, subdivisionMidScratch))
      var g1 = Matrix2.Cartesian3.magnitudeSquared(Matrix2.Cartesian3.subtract(s1, s2, subdivisionMidScratch))
      var g2 = Matrix2.Cartesian3.magnitudeSquared(Matrix2.Cartesian3.subtract(s2, s0, subdivisionMidScratch))
      ...
      if (max > minDistance) {
        if (g0 === max) {
          ...
          if (!when.defined(i)) {
            ...
            midCartesian3 = Matrix2.Cartesian3.fromRadians(mid.longitude, mid.latitude, midHeight, ellipsoid, subdivisionMidScratch)
