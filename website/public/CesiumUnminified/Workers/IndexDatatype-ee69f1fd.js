...
define(['exports', './when-4bbc8319', './RuntimeError-346a3079', './ComponentDatatype-f194c48b', './WebGLConstants-1c8239cc'], function (
  exports,
  when,
  RuntimeError,
  ComponentDatatype,
  ...
  IndexDatatype.getSizeInBytes = function (indexDatatype) {
    ...
    throw new RuntimeError.DeveloperError('indexDatatype is required and must be a valid IndexDatatype constant.')
    //>>includeEnd('debug');
  }
  ...
  IndexDatatype.fromSizeInBytes = function (sizeInBytes) {
    switch (sizeInBytes) {
      ...
      //>>includeStart('debug', pragmas.debug);
      default:
        throw new RuntimeError.DeveloperError('Size in bytes cannot be mapped to an IndexDatatype')
      //>>includeEnd('debug');
    }
  }
