...
define([
  ...
  './Plane-4f333bc4',
  './Transforms-86b6fa28'
], function (exports, AxisAlignedBoundingBox, Matrix2, RuntimeError, when, IntersectionTests, Plane, Transforms) {
  'use strict'
  ...
  function EllipsoidTangentPlane(origin, ellipsoid) {
    ...
    if (!when.defined(origin)) {
      throw new RuntimeError.DeveloperError('origin must not be at the center of the ellipsoid.')
    }
    //>>includeEnd('debug');
    ...
    this._origin = origin
    this._xAxis = Matrix2.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 0, scratchCart4))
    this._yAxis = Matrix2.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 1, scratchCart4))

    var normal = Matrix2.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 2, scratchCart4))
  ...
  EllipsoidTangentPlane.prototype.projectPointOntoPlane = function (cartesian, result) {
    ...
    if (when.defined(intersectionPoint)) {
      var v = Matrix2.Cartesian3.subtract(intersectionPoint, this._origin, intersectionPoint)
