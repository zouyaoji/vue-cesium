define([
  ...
  './Plane-c27e1ac6',
  './Transforms-9052372a'
], function (exports, AxisAlignedBoundingBox, Matrix2, Matrix3, Check, defaultValue, IntersectionTests, Plane, Transforms) {
  'use strict'
  ...
  function EllipsoidTangentPlane(origin, ellipsoid) {
    ...
    const normal = Matrix3.Cartesian3.fromCartesian4(Matrix2.Matrix4.getColumn(eastNorthUp, 2, scratchCart4))
  ...
  EllipsoidTangentPlane.prototype.projectPointOntoPlane = function (cartesian, result) {
    ...
    let intersectionPoint = IntersectionTests.IntersectionTests.rayPlane(ray, this._plane, scratchProjectPointOntoPlaneCartesian3)
