...
define([
  ...
  function computeExtrudedEllipse(options) {
    ...
    numberOfVerticalLines = ComponentDatatype.CesiumMath.clamp(numberOfVerticalLines, 0, length / 2)
   ...
   * @type {Number}
   */
  EllipseOutlineGeometry.packedLength = Matrix2.Cartesian3.packedLength + Matrix2.Ellipsoid.packedLength + 8
