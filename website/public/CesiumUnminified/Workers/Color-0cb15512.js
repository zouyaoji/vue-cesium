...
define(['exports', './RuntimeError-346a3079', './when-4bbc8319', './Transforms-86b6fa28', './ComponentDatatype-f194c48b'], function (
  exports,
  RuntimeError,
  when,
  Transforms,
  ...
  Color.fromRandom = function (options, result) {
    ...
    if (!when.defined(red)) {
      ...
      red = minimumRed + ComponentDatatype.CesiumMath.nextRandomNumber() * (maximumRed - minimumRed)
    }
    ...
    if (!when.defined(green)) {
      ...
      //>>includeStart('debug', pragmas.debug);
      RuntimeError.Check.typeOf.number.lessThanOrEquals('minimumGreen', minimumGreen, maximumGreen)
      //>>includeEnd('debug');
      green = minimumGreen + ComponentDatatype.CesiumMath.nextRandomNumber() * (maximumGreen - minimumGreen)
    }
    ...
    if (!when.defined(blue)) {
      ...
      //>>includeStart('debug', pragmas.debug);
      RuntimeError.Check.typeOf.number.lessThanOrEquals('minimumBlue', minimumBlue, maximumBlue)
      //>>includeEnd('debug');

      blue = minimumBlue + ComponentDatatype.CesiumMath.nextRandomNumber() * (maximumBlue - minimumBlue)
    }
    ...
    if (!when.defined(alpha)) {
      ...
      //>>includeStart('debug', pragmas.debug);
      RuntimeError.Check.typeOf.number.lessThanOrEquals('minumumAlpha', minimumAlpha, maximumAlpha)
      //>>includeEnd('debug');

      alpha = minimumAlpha + ComponentDatatype.CesiumMath.nextRandomNumber() * (maximumAlpha - minimumAlpha)
    }
