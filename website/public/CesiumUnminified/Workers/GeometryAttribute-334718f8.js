define([
  ...
  const boundingRectanglePointsCartographicScratch = [new Matrix3.Cartographic(), new Matrix3.Cartographic(), new Matrix3.Cartographic()]
  const boundingRectanglePointsEnuScratch = [new Matrix2.Cartesian2(), new Matrix2.Cartesian2(), new Matrix2.Cartesian2()]
  ...
  Geometry._textureCoordinateRotationPoints = function (positions, stRotation, ellipsoid, boundingRectangle) {
    ...
    const enuToFixedFrame = Transforms.Transforms.eastNorthUpToFixedFrame(enuCenter, ellipsoid, fixedFrameToEnuScratch)
    ...
    const rotation = Transforms.Quaternion.fromAxisAngle(Matrix3.Cartesian3.UNIT_Z, -stRotation, enuRotationScratch)
