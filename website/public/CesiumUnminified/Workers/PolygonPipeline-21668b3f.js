define([
...
], function (exports, Matrix2, Matrix3, Check, ComponentDatatype, defaultValue, EllipsoidRhumbLine, GeometryAttribute, Math$1, WebGLConstants) {
  'use strict'
  ...
  PolygonPipeline.computeSubdivision = function (ellipsoid, positions, indices, texcoords, granularity) {
    ...
    while (triangles.length > 0) {
      ...
      const s0 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v0, subdivisionS0Scratch), radius, subdivisionS0Scratch)
      const s1 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v1, subdivisionS1Scratch), radius, subdivisionS1Scratch)
      const s2 = Matrix3.Cartesian3.multiplyByScalar(Matrix3.Cartesian3.normalize(v2, subdivisionS2Scratch), radius, subdivisionS2Scratch)

      const g0 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s0, s1, subdivisionMidScratch))
      const g1 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s1, s2, subdivisionMidScratch))
      const g2 = Matrix3.Cartesian3.magnitudeSquared(Matrix3.Cartesian3.subtract(s2, s0, subdivisionMidScratch))
