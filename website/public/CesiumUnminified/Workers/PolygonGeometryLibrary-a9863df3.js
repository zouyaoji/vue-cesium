...
define([
  ...
  PolygonGeometryLibrary.unpackPolygonHierarchy = function (array, startingIndex) {
    ...
    for (var i = 0; i < positionsLength; ++i, startingIndex += Matrix2.Cartesian3.packedLength) {
  ...
  function getPointAtDistance(p0, p1, distance, length) {
    ...
    Matrix2.Cartesian3.multiplyByScalar(distanceScratch, distance / length, distanceScratch)
  ...
  PolygonGeometryLibrary.polygonOutlinesFromHierarchy = function (polygonHierarchy, scaleToEllipsoidSurface, ellipsoid) {
    ...
    while (queue.length !== 0) {
      ...
      outerRing = arrayRemoveDuplicates.arrayRemoveDuplicates(outerRing, Matrix2.Cartesian3.equalsEpsilon, true)
      ...
      for (i = 0; i < numChildren; i++) {
        ...
        holePositions = arrayRemoveDuplicates.arrayRemoveDuplicates(holePositions, Matrix2.Cartesian3.equalsEpsilon, true)
  ...
  PolygonGeometryLibrary.computeBoundingRectangle = function (planeNormal, projectPointTo2D, positions, angle, result) {
    ...
    var textureMatrix = Matrix2.Matrix3.fromQuaternion(rotation, computeBoundingRectangleMatrix3)
  ...
  PolygonGeometryLibrary.computeWallGeometry = function (positions, ellipsoid, granularity, perPositionHeight, arcType) {
    ...
    for (i = 0; i < length; i++) {
      ...
      if (Matrix2.Cartesian3.equalsEpsilon(p1, p2, ComponentDatatype.CesiumMath.EPSILON10, ComponentDatatype.CesiumMath.EPSILON10)) {
        //skip corner
        continue
      }
...
//# sourceMappingURL=PolygonGeometryLibrary-a9863df3.js.map
