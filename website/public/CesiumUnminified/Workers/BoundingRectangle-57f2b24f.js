define(['exports', './Matrix2-1e403d0e', './Matrix3-fa806b97', './Check-6ede7e26', './defaultValue-fe22d8c0', './Transforms-9052372a'], function (
  exports,
  Matrix2,
  Matrix3,
  Check,
  ...
  BoundingRectangle.fromRectangle = function (rectangle, projection, result) {
    ...
    const lowerLeft = projection.project(Matrix2.Rectangle.southwest(rectangle, fromRectangleLowerLeft))
    const upperRight = projection.project(Matrix2.Rectangle.northeast(rectangle, fromRectangleUpperRight))
