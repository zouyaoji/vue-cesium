define(['exports', './Matrix2-163b5a1d', './Matrix3-b6f074fa', './defaultValue-0a909f67', './Transforms-dadc538f'], function (t, e, n, i, h) {
  'use strict'
  function r(t, e, n, h) {
    ...
    (r.fromPoints = function (t, e) {
      ...
      for (let e = 1; e < n; e++) {
        const n = t[e],
          i = n.x,
          r = n.y
        ;(h = Math.min(i, h)), (d = Math.max(i, d)), (a = Math.min(r, a)), (u = Math.max(r, u))
      }
      return (e.x = h), (e.y = a), (e.width = d - h), (e.height = u - a), e
    })
  const a = new h.GeographicProjection(),
    d = new n.Cartographic(),
    u = new n.Cartographic()
  ;(r.fromRectangle = function (t, n, h) {
    if ((i.defined(h) || (h = new r()), !i.defined(t))) return (h.x = 0), (h.y = 0), (h.width = 0), (h.height = 0), h
    const o = (n = i.defaultValue(n, a)).project(e.Rectangle.southwest(t, d)),
