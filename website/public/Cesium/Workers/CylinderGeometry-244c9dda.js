define([
...
], function (t, e, n, a, o, r, i, s, u, m, l, c, f) {
  'use strict'
  ...
  function x(t) {
    const e = (t = i.defaultValue(t, i.defaultValue.EMPTY_OBJECT)).length,
      n = t.topRadius,
      a = t.bottomRadius,
      o = i.defaultValue(t.vertexFormat, f.VertexFormat.DEFAULT),
  ...
  ;(x.packedLength = f.VertexFormat.packedLength + 5),
    (x.pack = function (t, e, n) {
      return (
        (n = i.defaultValue(n, 0)),
        f.VertexFormat.pack(t._vertexFormat, e, n),
        (n += f.VertexFormat.packedLength),
        (e[n++] = t._length),
        (e[n++] = t._topRadius),
        (e[n++] = t._bottomRadius),
        (e[n++] = t._slices),
  ...
  ;(x.unpack = function (t, e, n) {
    ...
    const a = f.VertexFormat.unpack(t, e, g)
    ...
    const o = t[e++],
      ...
      m = t[e]
    return i.defined(n)
      ? ((n._vertexFormat = f.VertexFormat.clone(a, n._vertexFormat)),
        (n._length = o),
        (n._topRadius = r),
        (n._bottomRadius = s),
        (n._slices = u),
    ...
    (x.createGeometry = function (t) {
      ...
      const x = t._topRadius,
        ...
        _ = t._vertexFormat,
        h = t._slices
      if (f <= 0 || x < 0 || g < 0 || (0 === x && 0 === g)) return
      const F = h + h,
        v = h + F,
        C = F + F,
        w = r.CylinderGeometryLibrary.computePositions(f, x, g, h, !0),
      ...
      _.position && (E.position = new s.GeometryAttribute({ componentDatatype: o.ComponentDatatype.DOUBLE, componentsPerAttribute: 3, values: w })),
        ...
        (d.x = 0.5 * f),
        (d.y = Math.max(g, x))
      const N = new e.BoundingSphere(a.Cartesian3.ZERO, n.Cartesian2.magnitude(d))
      if (i.defined(t._offsetAttribute)) {
        f = w.length
        const e = t._offsetAttribute === m.GeometryOffsetAttribute.NONE ? 0 : 1,
          n = new Uint8Array(f / 3).fill(e)
    ...
    (x.getUnitCylinder = function () {
      return (
        i.defined(h) || (h = x.createGeometry(new x({ topRadius: 1, bottomRadius: 1, length: 1, vertexFormat: f.VertexFormat.POSITION_ONLY }))), h
      )
    }),
