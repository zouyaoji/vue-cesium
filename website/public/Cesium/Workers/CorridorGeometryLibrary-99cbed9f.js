define([
  ...
  function E(a, t, i, o, y) {
    ...
    ;(p[d - 3] = i.x),
      ...
      (p[d - 1] = i.z),
      (m = y
        ? e.Matrix3.fromQuaternion(s.Quaternion.fromAxisAngle(e.Cartesian3.negate(a, l), c / u, P), A)
        : e.Matrix3.fromQuaternion(s.Quaternion.fromAxisAngle(a, c / u, P), A))
    let g = 0
    t = e.Cartesian3.clone(t, l)
    for (let a = 0; a < u; a++) (t = e.Matrix3.multiplyByVector(m, t, t)), (p[g++] = t.x), (p[g++] = t.y), (p[g++] = t.z)
    return p
  }
  function S(a, n, t, r) {
    let i = l
  ...
  o.computePositions = function (a) {
    ...
    for (H = 1; H < J - 1; H++) {
      ...
      if (!r.CesiumMath.equalsEpsilon(Math.abs(e.Cartesian3.dot(a, d)), 1, r.CesiumMath.EPSILON7)) {
        ;(L = e.Cartesian3.cross(L, P, L)), (L = e.Cartesian3.cross(P, L, L)), (L = e.Cartesian3.normalize(L, L))
