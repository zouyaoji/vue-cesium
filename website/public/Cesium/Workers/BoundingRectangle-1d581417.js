define(['exports', './Matrix2-413c4048', './Matrix3-81054f0f', './defaultValue-f6d5e6da', './Transforms-20461479'], function (t, e, n, i, h) {
  'use strict'
  function r(t, e, n, h) {
    ...
    (r.fromPoints = function (t, e) {
      ...
      for (let e = 1; e < n; e++) {
        const n = t[e],
          i = n.x,
          r = n.y
        ;(h = Math.min(i, h)), (d = Math.max(i, d)), (u = Math.min(r, u)), (a = Math.max(r, a))
      }
  ...
  ;(r.fromRectangle = function (t, n, h) {
    ...
    (r.intersect = function (t, e) {
      const n = t.x,
        ...
        r = e.x,
        u = e.y
      return n > r + e.width || n + t.width < r || i + t.height < u || i > u + e.height ? h.Intersect.OUTSIDE : h.Intersect.INTERSECTING
    }),
