define([
  ...
  y.fromPoints = function (e, t) {
    ...
    const o = n.Cartesian3.clone(e[0], S),
      ...
      a = n.Cartesian3.clone(o, _),
      u = n.Cartesian3.clone(o, C),
  ...
  ;(y.fromRectangle3D = function (e, t, o, s) {
    ...
    (y.fromVertices = function (e, t, o, i) {
      ...
      const a = n.Cartesian3.clone(s, v),
        ...
        c = n.Cartesian3.clone(s, _),
        l = n.Cartesian3.clone(s, C),
    ...
    (y.fromEncodedCartesianVertices = function (e, t, o) {
      ...
      const s = n.Cartesian3.clone(i, v),
        ...
        u = n.Cartesian3.clone(i, _),
        c = n.Cartesian3.clone(i, C),
  ...
  Object.defineProperties(oe, {
    ...
    (oe._names = re)
  var ie = oe
  let se, ae, ue, ce, le, de, fe, pe, he, me, ge, ye, ve, we, _e, Ce, be, xe
  function Se(e) {
    const t = e.split('.')
  ...
  const Me = {
    ...
    isIPadOrIOS: function () {
      return r.defined(_e) || (_e = 'iPhone' === navigator.platform || 'iPod' === navigator.platform || 'iPad' === navigator.platform), _e
    },
    hardwareConcurrency: r.defaultValue(se.hardwareConcurrency, 3),
    supportsPointerEvents: function () {
      return r.defined(Ce) || (Ce = !Re() && 'undefined' != typeof PointerEvent && (!r.defined(se.pointerEnabled) || se.pointerEnabled)), Ce
    },
  ...
  function zt(e, t, n) {
    ...
    const o = 0 | e
    bt(o, (t += (e - o) * ht.SECONDS_PER_DAY), this), n === mt.UTC && _t(this)
  }
  ;(zt.fromGregorianDate = function (e, t) {
    const n = xt(e.year, e.month, e.day, e.hour, e.minute, e.second, e.millisecond)
    return r.defined(t) ? (bt(n[0], n[1], t), _t(t), t) : new zt(n[0], n[1], mt.UTC)
  }),
    ...
    (zt.fromIso8601 = function (e, t) {
      ...
      return r.defined(t) ? (bt(y[0], y[1], t), _t(t)) : (t = new zt(y[0], y[1], mt.UTC)), g && zt.addSeconds(t, 1, t), t
    }),
    (zt.now = function (e) {
  ...
  ;(zt.toGregorianDate = function (e, t) {
    let n = !1,
      o = Ct(e, Mt)
    r.defined(o) || (zt.addSeconds(e, -1, Mt), (o = Ct(Mt, Mt)), (n = !0))
    let i = o.dayNumber
              ...
              !(function (n) {
                ...
                function S(e) {
                  var t,
                    ...
                    w = 128,
                    _ = 72
                  for ((n = e.lastIndexOf('-')) < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && y('not-basic'), h.push(e.charCodeAt(r))
                  for (o = n > 0 ? n + 1 : 0; o < g; ) {
                    for (
                      i = v, s = 1, a = c;
                      o >= g && y('invalid-input'),
                        ((l = (p = e.charCodeAt(o++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : c) >= c ||
                          l > m((u - v) / s)) &&
                          y('overflow'),
                        (v += l * s),
                        !(l < (d = a <= _ ? 1 : a >= _ + 26 ? 26 : a - _));
                      a += c
                    )
                      s > m(u / (f = c - d)) && y('overflow'), (s *= f)
                    ;(_ = x(v - i, (t = h.length + 1), 0 == i)), m(v / t) > u - w && y('overflow'), (w += m(v / t)), (v %= t), h.splice(v++, 0, w)
                  }
                  return C(h)
                }
                function A(e) {
                  var t,
                    ...
                    C,
                    S = []
                  for (h = (e = _(e)).length, t = 128, n = 0, i = 72, s = 0; s < h; ++s) (p = e[s]) < 128 && S.push(g(p))
                  for (r = o = S.length, o && S.push('-'); r < h; ) {
                    for (a = u, s = 0; s < h; ++s) (p = e[s]) >= t && p < a && (a = p)
                    for (a - t > m((u - n) / (v = r + 1)) && y('overflow'), n += (a - t) * v, t = a, s = 0; s < h; ++s)
                      if (((p = e[s]) < t && ++n > u && y('overflow'), p == t)) {
                        for (l = n, d = c; !(l < (f = d <= i ? 1 : d >= i + 26 ? 26 : d - i)); d += c)
                          (C = l - f), (w = c - f), S.push(g(b(f + (C % w), 0))), (l = m(C / w))
                        S.push(g(b(l, 0))), (i = x(n, v, r == o)), (n = 0), ++r
                      }
                    ++n, ++t
                  }
                  return S.join('')
  ...
  function en(e, t, n) {
    ...
    if (!r.defined(i)) {
      const e = document.createElement('canvas')
      ;(e.width = t), (e.height = n), (i = e.getContext('2d')), (i.globalCompositeOperation = 'copy'), (o[n] = i)
    }
  ...
  const vn = []
  let wn = {}
  const _n = 'undefined' != typeof document ? new Zt(document.location.href) : new Zt(),
    Cn = new dn()
  function bn() {}
  function xn(e) {
        ...
        .then(
          (function (e) {
            return function (t) {
              ...
              const n = e.deferred
              --mn.numberOfActiveRequests, --wn[e.serverKey], Cn.raiseEvent(), (e.state = an.RECEIVED), (e.deferred = void 0), n.resolve(t)
            }
          })(e)
        )
        .catch(
  ...
  ;(bn.maximumRequests = 50),
    ...
    (bn.requestsByServer = { 'api.cesium.com:443': 18, 'assets.cesium.com:443': 18 }),
    (bn.throttleRequests = !0),
    (bn.debugShowStatistics = !1),
    (bn.requestCompletedEvent = Cn),
    ...
    (bn.getServerKey = function (e) {
      let t = new Zt(e)
      '' === t.scheme() && ((t = new Zt(e).absoluteTo(_n)), t.normalize())
      let n = t.authority()
    ...
    (bn.request = function (e) {
      if (sn(e.url) || nn(e.url)) return Cn.raiseEvent(), (e.state = an.RECEIVED), e.requestFunction()
      if (
  ...
  fr.headingPitchRollToFixedFrame = function (e, t, o, s, a) {
    ...
    const u = Ue.fromHeadingPitchRoll(t, _r),
      c = i.Matrix4.fromTranslationQuaternionRotationScale(n.Cartesian3.ZERO, u, Cr, br)
