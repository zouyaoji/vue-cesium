define([
  ...
  function S(t) {
    ...
    let u, c
    n instanceof z ? ((u = 0), (c = z.packedLength)) : n instanceof v && ((u = 1), (c = v.packedLength)),
      (this._frustumType = u),
  ...
  S.pack = function (t, n, i) {
    i = r.defaultValue(i, 0)
    const o = t._frustumType,
      s = t._frustum
    return (
      (n[i++] = o),
      0 === o ? (z.pack(s, n, i), (i += z.packedLength)) : (v.pack(s, n, i), (i += v.packedLength)),
  ...
  const T = new z(),
    ...
    A = new e.Quaternion(),
    D = new a.Cartesian3(),
    I = new l.VertexFormat()
  function q(t, e, a, n, i, o, s, f) {
    const u = (t / 3) * 2
    for (let i = 0; i < 4; ++i)
  ...
  S.unpack = function (t, n, i) {
    n = r.defaultValue(n, 0)
    const o = t[n++]
    let s
    0 === o ? ((s = z.unpack(t, n, T)), (n += z.packedLength)) : ((s = v.unpack(t, n, k)), (n += v.packedLength))
    const f = a.Cartesian3.unpack(t, n, D)
    n += a.Cartesian3.packedLength
    const u = e.Quaternion.unpack(t, n, A)
    n += e.Quaternion.packedLength
    const c = l.VertexFormat.unpack(t, n, I),
      h = 1 === t[(n += l.VertexFormat.packedLength)]
    if (!r.defined(i)) return new S({ frustum: s, origin: f, orientation: u, vertexFormat: c, _drawNearPlane: h })
  ...
  const B = new a.Matrix3(),
    ...
    J = new Array(3),
    W = new Array(4)
  ;(W[0] = new n.Cartesian4(-1, -1, 1, 1)),
    (W[1] = new n.Cartesian4(1, -1, 1, 1)),
    (W[2] = new n.Cartesian4(1, 1, 1, 1)),
    (W[3] = new n.Cartesian4(-1, 1, 1, 1))
  const X = new Array(4)
  for (let t = 0; t < 4; ++t) X[t] = new n.Cartesian4()
  ;(S._computeNearFarPlanes = function (t, e, i, o, s, f, u, l) {
    const c = a.Matrix3.fromQuaternion(e, B)
    let h = r.defaultValue(f, G),
      p = r.defaultValue(u, j),
      d = r.defaultValue(l, U)
    ...
    const m = n.Matrix4.computeView(t, d, p, h, L)
    let C, _
    if (0 === i) {
      const t = o.projectionMatrix,
        e = n.Matrix4.multiply(t, m, N)
      _ = n.Matrix4.inverse(e, N)
    } else C = n.Matrix4.inverseTransformation(m, N)
    r.defined(_) ? ((J[0] = o.near), (J[1] = o.far)) : ((J[0] = 0), (J[1] = o.near), (J[2] = o.far))
    for (let e = 0; e < 2; ++e)
      for (let i = 0; i < 4; ++i) {
        let f = n.Cartesian4.clone(W[i], X[i])
        if (r.defined(_)) {
          ...
          a.Cartesian3.multiplyByScalar(f, J[e] / r, f), a.Cartesian3.add(f, t, f)
        } else {
    ...
    (S.createGeometry = function (t) {
      ...
      S._computeNearFarPlanes(u, l, n, f, d)
      let m = 24
      ;(d[m] = d[12]),
        (d[m + 1] = d[13]),
        (d[m + 2] = d[14]),
      ...
      if (r.defined(h.normal) || r.defined(h.tangent) || r.defined(h.bitangent) || r.defined(h.st)) {
        const t = r.defined(h.normal) ? new Float32Array(12 * p) : void 0,
          ...
          u = j,
          l = U,
          d = a.Cartesian3.negate(f, Q),
          _ = a.Cartesian3.negate(u, K),
          y = a.Cartesian3.negate(l, Y)
        ;(m = 0),
          c && (q(m, t, e, n, s, y, f, u), (m += 12)),
          q(m, t, e, n, s, l, d, u),
          (m += 12),
          q(m, t, e, n, s, d, y, u),
          (m += 12),
