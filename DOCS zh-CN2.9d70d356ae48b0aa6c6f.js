...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/controls/vc-navigation.md?vue&type=template&id=42156943

var vc_navigationvue_type_template_id_42156943_hoisted_1 = {
  class: "content element-doc"
};

var vc_navigationvue_type_template_id_42156943_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["l" /* createStaticVNode */])("<h2 id=\"vcnavigation\"><a class=\"header-anchor\" href=\"#vcnavigation\">¶</a> VcNavigation</h2><p>导航组件，包括罗盘、缩放、其他悬浮按钮，位置和距离比例尺工具栏控件。由 <code>vc-compass</code>、<code>vc-zoom-control</code>、<code>vc-print</code>、<code>vc-mylocation</code>、<code>vc-status-bar</code>、<code>vc-distance-legend</code> 组合而成。</p><p><strong>注意：</strong> 需要引入样式文件: <code>import &#39;vue-cesium/lib/theme-default/index.css&#39;;</code></p><div class=\"tip\"><p>提示：3.0 版本对导航组件进行了重构，现在是一个集合组件，现在支持自定义风格，包括图标、大小、颜色位置等。如需高度定制，可分别参考各子组件的例子。自带的图标用的是 Unicode 方式，不支持多色，需要支持多色请参考阿里云 iconfont 介绍的使用 Symbol 的方法：<a href=\"https://www.iconfont.cn/help/detail?spm=a313x.7781069.1998910419.d8cf4382a&amp;helptype=code\">传送门</a>。</p></div><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>导航组件的基础用法。</p>", 6);
...
function vc_navigationvue_type_template_id_42156943_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["F" /* openBlock */])(), Object(vue_esm_browser["i" /* createBlock */])("section", vc_navigationvue_type_template_id_42156943_hoisted_1, [vc_navigationvue_type_template_id_42156943_hoisted_2, Object(vue_esm_browser["n" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/controls/vc-navigation.md?vue&type=template&id=42156943
...
vc_navigationvue_type_script_lang_ts.render = vc_navigationvue_type_template_id_42156943_render
