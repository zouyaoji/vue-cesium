...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/geometries/vc-geometry-polygon.md?vue&type=template&id=78d253f5

const vc_geometry_polygonvue_type_template_id_78d253f5_hoisted_1 = {
  class: "content element-doc"
};

const vc_geometry_polygonvue_type_template_id_78d253f5_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["createStaticVNode"])("<h2 id=\"vcgeometrypolygon\"><a class=\"header-anchor\" href=\"#vcgeometrypolygon\">¶</a> VcGeometryPolygon</h2><p>加载多边形，相当于初始化一个 <code>Cesium.PolygonGeometry</code> 实例。</p><p><strong>注意</strong>：需要作为 <code>vc-instance-geometry</code> 的子组件才能正常加载。 加载海量面图元时可以考虑用 <code>vc-collection-primitive</code> 组件和其 <code>polygons</code> 属性来渲染。</p><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3><p>多边形几何图形组件的基础用法。</p>", 5);
...
function vc_geometry_polygonvue_type_template_id_78d253f5_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["openBlock"])(), Object(vue_esm_browser["createElementBlock"])("section", vc_geometry_polygonvue_type_template_id_78d253f5_hoisted_1, [vc_geometry_polygonvue_type_template_id_78d253f5_hoisted_2, Object(vue_esm_browser["createVNode"])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/geometries/vc-geometry-polygon.md?vue&type=template&id=78d253f5
...
vc_geometry_polygonvue_type_script_lang_ts.render = vc_geometry_polygonvue_type_template_id_78d253f5_render
